<template>
  <div>
    ...
    <el-card class="box-card">
      ...
      <el-row :gutter="10">
        <el-col :span="8">
          <el-input placeholder="请输入内容" class="input-with-select" v-model="queryInfo.query" clearable>
            <el-button slot="append" icon="el-icon-search" @click="getclasscificationlist"></el-button>
          </el-input>
        </el-col>
        <el-col :span="2">
      ...
      <!--用户列表区 -->
      <el-table :data="classcificationlist" border stripe>
    ...
    <el-button type="primary" @click="addclasscification">确 定</el-button>
  </span>
    </el-dialog>
    <!--修改用户的对话框-->
    <el-dialog
...
export default {
  ...
  methods: {
    async getclasscificationlist() {
      ...
      this.classcificationlist = res.data.classcification
    ...
    async addclasscification() {
      ...
      await this.getclasscificationlist()
    },
    editDialogClose() {
